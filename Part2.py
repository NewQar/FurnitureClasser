...
TRAIN_DIR = r"C:\Users\User\Downloads\GroupAssignmentAiCSC577\Train" #dont forget the last /
...
VALIDATION_DIR = r"C:\Users\User\Downloads\GroupAssignmentAiCSC577\Valid"
...
best_model_file_path = r"C:\Users\User\Downloads\GroupAssignmentAiCSC577\new\Best"
...
model = Sequential([
    ...
    Dense(512, activation='relu'), 
    Dense(6,activation='softmax') # values between 0 to 1 
])
...
model.save(r'C:\Users\User\Downloads\GroupAssignmentAiCSC577\new\Best2')